/* A class teacher has decided to split her entire class into four groups, namely Sapphire, 
  ...
  All the students are represented by their roll numbers. Based on the above pattern, given 
  the roll number as input, print the group the student belongs to. Note that the roll number
